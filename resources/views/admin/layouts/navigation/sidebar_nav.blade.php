<div class="col-md-2 js-aside">
    ...
    <div id="aside-nav" class="panel-group">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#aside-nav" href="#aside-nav-4">Korisnici</a>
                </h3>
            </div>
            <div class="panel-collapse collapse in" id="aside-nav-4">
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked">
                        <li class=""><a href="{{route('admin.users')}}">Korisnici</a></li>
                    </ul>
                </div>
            </div>
            <!-- =aside-nav-views -->
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#aside-nav" href="#aside-nav-1">Naslovna strana</a>
                    </h3>
                </div>
                <div class="panel-collapse collapse in" id="aside-nav-1">
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
							...
							<li class=""><a href="{{route('admin.home','1')}}">Naslovna strana text</a></li>
                            <li class=""><a href="{{route('admin.home-gallery')}}">Naslovna strana gallery</a></li>
            ...
            <div class="panel-collapse collapse in" id="aside-nav-4">
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class=""><a href="{{route('admin.prof-text', 1)}}">Profesori Text</a></li>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#aside-nav" href="#aside-nav-6">Galerija</a>
                </h3>
            </div>
            <div class="panel-collapse collapse in" id="aside-nav-6">
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class=""><a href="{{route('admin.gallery')}}">Galerija</a></li>
                        <li class=""><a href="{{route('admin.gallery-text')}}">Galerija Text</a></li>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#aside-nav" href="#aside-nav-5">Vesti</a>
                </h3>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#aside-nav" href="#aside-nav-6">Linkovi</a>
                </h3>
            </div>
            <div class="panel-collapse collapse in" id="aside-nav-5">
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class=""><a href="{{route('admin.links')}}">Linkovi</a></li>
                    </ul>
                </div>
            </div>
            <!-- =aside-nav-views -->
