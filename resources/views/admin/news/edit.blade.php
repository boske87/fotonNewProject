        ...
        <div class="panel-body">
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tab-1">
                    ...
                    {!! Form::open(['method' => 'PATCH','route' => ['admin.news.update', $id], 'files' => true, 'class' => 'form-horizontal']) !!}
                    ...
                    <!-- Image ALT Form Input -->
                        <div class="form-group{!! $errors ->has('head') ? ' has-error' : '' !!}">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('head', $item->head, ['class' => 'form-control']) !!}
                        ...
                        <div class="form-group{!! $errors ->has('desc') ? ' has-error' : '' !!}">
                            ...
                            <div class="col-sm-10">
                                {!! Form::textarea('desc', $item->desc, ['id'=>'desc', 'class' => 'form-control', 'rows' => 8]) !!}
