...
@section('content')
                ...
                <div class="row">
                    <div class="row" style="width: 70% !important; margin-left: 15%; margin-top: 5%">
                        <button
                                ...
                                <span data-toggle="modal" data-target="#myModalIz">Dodajte nove Izlozbe i konkurse</span></a></button>
                    </div>
                            ...
                            <div class="span4">
                                <div class="vesti-box">
                                    ...
                                    <div class="vesti-info">
                                        ...
                                        <a onclick="return confirm('Da li sigurno zelite da obrisete?');" href="{{route('foton-klub.izlozbe-konkursi-brisanje', $oneGal->id)}}"
    ...
    <div id="myModalIz" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        {!! Form::open(['route' => 'foton-klub.izlozbe-konkursi']) !!}
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            <h3 id="myModalLabel">Dodajte nove Izlozbe i konkurse</h3>
        </div>
    ...
    @if($items->count()>0)
        ...
        <div id="myModalIzmena{{$oneGal->id}}" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            {!! Form::open(['method' => 'PATCH','route' => ['foton-klub.izlozbe-konkursi-izmena', $oneGal->id ]]) !!}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
